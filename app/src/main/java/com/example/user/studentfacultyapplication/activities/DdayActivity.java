...
import com.example.user.studentfacultyapplication.sql.DatabaseHelperD;
        ...
        btnviewUpdate.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isUpdate == true)
                            Toast.makeText(DdayActivity.this, "Data Update", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(DdayActivity.this, "Data not Updated", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean isInserted = myDb.insertData(edityear.getText().toString(), editfirst.getText().toString(),
                                editsecond.getText().toString(), editthird.getText().toString(), editfourth.getText().toString(), editfifth.getText().toString(), editsixth.getText().toString());
                        if (isInserted == true)
                            Toast.makeText(DdayActivity.this, "Data Inserted", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(DdayActivity.this, "Data not Inserted", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
