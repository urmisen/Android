    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CT_Marks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(UsersActivity.this, MarksActivity.class);
                startActivity(i);
            }
        });
        ...
        Routine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "Clicked on Button", Toast.LENGTH_SHORT).show();
                Intent j = new Intent(UsersActivity.this, RoutineActivity.class);
                startActivity(j);
            }
        });
        ...
        Result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "Clicked on Button", Toast.LENGTH_SHORT).show();
                Intent k = new Intent(UsersActivity.this, ResultActivity.class);
                startActivity(k);
            }
        });
        ...
        Notice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "Clicked on Button", Toast.LENGTH_SHORT).show();
                Intent l = new Intent(UsersActivity.this, NoticeActivity.class);
                startActivity(l);
            }
        });
