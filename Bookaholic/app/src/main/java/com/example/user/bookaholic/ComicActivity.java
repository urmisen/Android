        ...
        list_view.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                        ...
                        Toast.makeText(ComicActivity.this,"Position :"+ position + "value :"+ value,Toast.LENGTH_LONG).show();
                        ...
                        if (position == 1) {
                            Toast.makeText(ComicActivity.this,"Position :"+ position + "OOPS! Still Under Construction "+ value,Toast.LENGTH_LONG).show();
                        }
                        if (position == 2) {
                            Toast.makeText(ComicActivity.this,"Position :"+ position + "OOPS! Still Under Construction "+ value,Toast.LENGTH_LONG).show();
                        }
